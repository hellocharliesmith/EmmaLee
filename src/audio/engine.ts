...
// defaults. cloudsSend has no per-track UI knob yet (v1 — see BACKLOG.md "Clouds Send
// knob per track"), just a fixed default level, same architectural pattern as the other
// two sends so it's a small follow-up to expose later.
